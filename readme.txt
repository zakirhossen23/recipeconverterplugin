...
Installing "upcomingCourses" can be done either by searching for "upcomingCourses" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
